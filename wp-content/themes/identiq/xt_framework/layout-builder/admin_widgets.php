<?php
	...
	function widget_section_wrapper($content, $title, $content_json = null) {
		global $idn;
		global $idw;
		...
		$output = '
				<div class="wpts-widget wrapper-start">
					<input type="hidden" name="" class="wid-parent">
					<h6><a href="#" class="edit-widget edit-widget-wrapper"># '.stripslashes($title).'</a><a href="#" class="remove-widget">X</a></h6>
					<input class="wid-1" type="hidden" value="widget" name="elements['.$idn.'][2]['; $output .= $idw; $idw++; $output .=']" />
					<input class="wid-2" type="hidden" value="section_wrapper" name="elements['.$idn.'][2]['; $output .= $idw; $idw++; $output .=']" />
					<textarea class="wid-3" name="elements['.$idn.'][2]['; $output .= $idw; $idw++; $output .=']">'.stripslashes($content).'</textarea>
					<input class="wid-title" type="hidden" value="'.stripslashes($title).'" name="elements['.$idn.'][2]['; $output .= $idw; $idw++; $output .=']" />
					<textarea class="wid-4" name="elements['.$idn.'][2]['; $output .= $idw; $idw++; $output .=']">'.stripslashes($content_json).'</textarea>
				</div>
				<script>
					idn+= 4;
				</script>
	...
	function widget_section_wrapper_end($content, $title) {
		global $idn;
		global $idw;

		$output = '
				<div class="wpts-widget wrapper-end">
					<input type="hidden" name="" class="wid-parent">
					<h6><a href="#" class="edit-widget"># '.stripslashes($title).'</a><a href="#" class="remove-widget">X</a></h6>
					<input class="wid-1" type="hidden" value="widget" name="elements['.$idn.'][2]['; $output .= $idw; $idw++; $output .=']" />
					<input class="wid-2" type="hidden" value="section_wrapper_end" name="elements['.$idn.'][2]['; $output .= $idw; $idw++; $output .=']" />
					<textarea class="wid-3" name="elements['.$idn.'][2]['; $output .= $idw; $idw++; $output .=']">'.stripslashes($content).'</textarea>
					<input class="wid-title" type="hidden" value="'.stripslashes($title).'" name="elements['.$idn.'][2]['; $output .= $idw; $idw++; $output .=']" />
				</div>
				<script>
