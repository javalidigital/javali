...
function optionsframework_page() {
	...
	<div class="clear clearboth xt-clear" style="clear: both; display: block;"></div>
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<?php $section = 1; if(isset($_GET['section'])) $section = $_GET['section']; ?>
...
function optionsframework_validate( $input ) {
	...
	/* Get Section that is being showed */
	...
	$clean = array();
	$options = optionsframework_options($section);

	$config = get_option( 'optionsframework' );
	$config = get_option( $config['id'] );
	...
	*/
	...
	echo '----- #COMBINED -----';
	$clean = array_merge($config, $clean);
	var_dump($clean);
	*/
