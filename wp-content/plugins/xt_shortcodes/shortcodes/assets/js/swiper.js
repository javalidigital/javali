        ...
        if (params.slidesPerView==='auto') {
            ...
            if (params.calculateHeight) {
                ...
                if (isH) { 
                	...
                	containerSize = slideHeight * params.slidesPerView , _this.container.style.height= containerSize+'px';
            ...
            if(params.slidesPerViewTablet != 1 || params.slidesPerViewMobile != 1 ) {
	         
	            var _window = jQuery(window).width();

	            /* Tablet */
	            if(_window >= 768 && _window <= 959) {
	            	params.slidesPerView = params.slidesPerViewTablet;
	            }

	            /* Mobile */
	            if(_window <= 767) {
	            	params.slidesPerView = params.slidesPerViewMobile;
	            }

	            /* Normal */
	            if(_window > 969) {
	            	params.slidesPerView = params.slidesPerViewBackup;
	            }
            }
