jQuery(document).ready(function() {
	...
	jQuery(document).on("click", '.dc-upload-admin', function(event) {

		var xt_meta_field_slider = null;

		xt_meta_field_slider = jQuery(this).siblings(".dc-upload-admin-input");
		...
		file_frame.on( 'select', function() {
			...
			xt_meta_field_slider.val(attachment.url);
