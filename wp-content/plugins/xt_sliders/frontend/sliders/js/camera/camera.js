						...
						if ($('.cameraeased', target).length == blocks) {
							...
							function () {
								...
								if (loader != 'pie') {
									...
									case 'leftToRight':
										$('#' + pieID).css({
											'right': $('.camera_bar_cont', camera_thumbs_wrap).width() - ($('.camera_bar_cont', camera_thumbs_wrap).width() * rad)
										});
										break;
									case 'rightToLeft':
										$('#' + pieID).css({
											'left': $('.camera_bar_cont', camera_thumbs_wrap).width() - ($('.camera_bar_cont', camera_thumbs_wrap).width() * rad)
										});
										break;
									case 'topToBottom':
										$('#' + pieID).css({
											'bottom': $('.camera_bar_cont', camera_thumbs_wrap).height() - ($('.camera_bar_cont', camera_thumbs_wrap).height() * rad)
										});
										break;
									case 'bottomToTop':
										$('#' + pieID).css({
											'top': $('.camera_bar_cont', camera_thumbs_wrap).height() - ($('.camera_bar_cont', camera_thumbs_wrap).height() * rad)
										});
										break;
									}
								} else {
